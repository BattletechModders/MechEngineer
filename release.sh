...
# -ir!HardpointFixMod
INCLUDES_ALL="$INCLUDES -i!Turbine.dll -ir!BattletechPerformanceFix -ir!SkipIntro -ir!SkipTutorial -ir!CBTHeat -ir!CBTMovement -ir!DynModLib -ir!pansar -ir!SkipTutorial -ir!SpeedMod ModTek.dll"
