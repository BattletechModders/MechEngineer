...
[CustomComponent("CarryHandUsageTopOffCapacityFactor")]
public class CarryHandUsageTopOffCapacityFactorCustom : SimpleCustomComponent, IValueComponent<float>, IAfterLoad
{
    private float Value;
